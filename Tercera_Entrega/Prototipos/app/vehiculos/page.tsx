...
import { RegistroVehiculoForm } from "@/components/vehiculos/registro-vehiculo-form"
        ...
        <div className="mx-auto max-w-4xl space-y-8">
          ...
          <div className="rounded-lg border border-border bg-card shadow-sm">
            <div className="border-b border-border bg-muted/50 px-6 py-4">
              ...
              <p className="mt-1 text-sm text-muted-foreground">Complete los datos del usuario y del vehículo a registrar</p>
            </div>
            <div className="p-6">
