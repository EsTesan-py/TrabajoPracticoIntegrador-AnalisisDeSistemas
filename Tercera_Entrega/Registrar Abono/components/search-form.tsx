...
import { buscarUsuario } from "@/lib/mock-data"
...
export default function SearchForm({ onUsuarioEncontrado }: SearchFormProps) {
    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Ingrese su número de Documento Nacional de Identidad (DNI) o número de Legajo
        </p>
      </div>
